...
from src.apps.profiles.serializers import ShortProfileSerializer
...
class InstructionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'id','body','display_order','instruction_ingredients',
            'is_completed',
        )
...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'total_time','servings','slug','is_purchasable','recipe_note',
            'has_like','like_count','has_cooked','ingredient_count',
            'created_at','updated_at','RecipeImage',
            'instructions','items',
        )
        read_only_fields = ('id','slug','has_like','like_count',
            'has_cooked','ingredient_count','created_at','updated_at',
        )
...
class ShortRecipeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Recipe
        fields = (
             'id','title','total_time','slug','is_purchasable','has_like','like_count','author','RecipeImage',
        )
        read_only_fields = (
             'id','title','total_time','slug','is_purchasable','has_like','like_count','author','RecipeImage',
        )
